...
public class AccountListenner implements ActionListener{
	private LoginPanel loginPanel;
	private LoginView loginView; 
	private AccountDAO accountDAO;
	private RegisterPanel registerPanel;

	public AccountListenner(RegisterPanel registerPanel, AccountDAO accountDAO) {
	    this.registerPanel = registerPanel;
	    this.accountDAO = accountDAO;
	   
	}
	
	public AccountListenner(LoginPanel loginPanel, AccountDAO accountDAO, LoginView loginView) {
